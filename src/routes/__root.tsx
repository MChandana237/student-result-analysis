...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EduMetric — Student Result Analysis" },
      { name: "description", content: "Modern university result analysis system for admins and students." },
      { property: "og:title", content: "EduMetric — Student Result Analysis" },
      { name: "twitter:title", content: "EduMetric — Student Result Analysis" },
